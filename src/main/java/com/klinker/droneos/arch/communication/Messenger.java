 ...
 * node that the message is being sent to is on the same device as the one it
 * was sent from, it will be sent in
 * {@link com.klinker.droneos.arch.nodes.NodeManager#sendMessage(Message)}.
 */
